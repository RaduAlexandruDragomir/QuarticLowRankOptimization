function [Y infos] = tr_dist_completion(Is,Js,knownDists,Y,trueDists,params)
...
% {b.mishra,g.meyer}@ulg.ac.be
  ...
  [Y, f, infos.costs, infos.time,infos.rmse] = trust_region(fun_set,fun_obj,Y,param_tr,params.tol,params.vtol,params.maxiter_tr,params.verb,trueDists);
  infos.iter = length(infos.costs);
  infos.rmse_time = infos.time;
end
